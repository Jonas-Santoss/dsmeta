...
public class SaleService { 
	...
	public Page<Sale> findSales(String minDate, String maxDate, Pageable pageable) { // Retorna uma lista de vendas
		...
		return repository.findSales(min, max, pageable);  // Busca todas as vendas  no banco de dados		
	}
}